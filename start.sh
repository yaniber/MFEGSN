...
echo "     → Running in Docker service 'pdf-rag-mcp'"
echo "     → Automatically started alongside the web interface"
echo "     → Use with VSCode Copilot or Roo Code"
echo "     → Check exact container name with: $DOCKER_COMPOSE_CMD ps"
echo ""
